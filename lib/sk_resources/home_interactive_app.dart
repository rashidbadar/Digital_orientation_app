...
class SKHomeInteractiveApp extends StatelessWidget {
  const SKHomeInteractiveApp({super.key});

  final List<Map<String, String>> apps = const [
    {
      "title": "Home Simulation",
      "image": "assets/images/sk-resources/textbooks/home_sim.png",
      "offline":
          "assets/html/sk/home_interactive_app/home_Simulation/index.html",
      "folder": "assets/html/sk/home_interactive_app/home_Simulation/",
    },
    {
      "title": "Home App",
      "image": "assets/images/sk-resources/textbooks/home_app.png",
      "offline": "assets/html/sk/home_interactive_app/home_app/index.html",
      "folder": "assets/html/sk/home_interactive_app/home_app/",
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("SK Home Interactive App")),
