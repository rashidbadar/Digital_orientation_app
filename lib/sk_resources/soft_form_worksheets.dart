...
class SKSoftFormWorksheets extends StatelessWidget {
  const SKSoftFormWorksheets({super.key});

  final List<Map<String, String>> worksheets = const [
    {
      "title": "Worksheets Simulation",
      "image": "assets/images/sk-resources/textbooks/worksheets_sim.png",
      "offline":
          "assets/html/sk/soft_form_worksheets/worksheets_Simulation/index.html",
      "folder": "assets/html/sk/soft_form_worksheets/worksheets_Simulation/",
    },
    {
      "title": "Worksheets App",
      "image": "assets/images/sk-resources/textbooks/worksheets_app.png",
      "offline":
          "assets/html/sk/soft_form_worksheets/worksheets_app/index.html",
      "folder": "assets/html/sk/soft_form_worksheets/worksheets_app/",
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("SK Soft Form Worksheets")),
