...
class RFAutoPaperGenerator extends StatelessWidget {
  const RFAutoPaperGenerator({super.key});

  final List<Map<String, String>> papers = const [
    {
      "title": "Auto Paper Simulation",
      "image": "assets/images/rf-resources/textbooks/auto_paper_sim.png",
      "offline":
          "assets/html/rf/auto_paper_generator/auto_paper_Simulation/index.html",
      "folder": "assets/html/rf/auto_paper_generator/auto_paper_Simulation/",
    },
    {
      "title": "Auto Paper App",
      "image": "assets/images/rf-resources/textbooks/auto_paper_app.png",
      "offline":
          "assets/html/rf/auto_paper_generator/auto_paper_app/index.html",
      "folder": "assets/html/rf/auto_paper_generator/auto_paper_app/",
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("RF Auto Paper Generator")),
