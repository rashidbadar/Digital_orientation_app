...
class AISoftFormKeyBooks extends StatelessWidget {
  const AISoftFormKeyBooks({super.key});

  final List<Map<String, String>> books = const [
    {
      "title": "Key Simulation",
      "image": "assets/images/ai-resources/key_simulation.png",
      "offline": "assets/html/ai/soft_form_key_books/key_Simulation/index.html",
      "folder": "assets/html/ai/soft_form_key_books/key_Simulation/",
    },
    {
      "title": "Key App",
      "image": "assets/images/ai-resources/key_app.png",
      "offline": "assets/html/ai/soft_form_key_books/key_app/index.html",
      "folder": "assets/html/ai/soft_form_key_books/key_app/",
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("AI Soft Form Key Books")),
