...
class AIAutoPaperGenerator extends StatelessWidget {
  const AIAutoPaperGenerator({super.key});

  final List<Map<String, String>> papers = const [
    {
      "title": "Auto Paper Simulation",
      "image": "assets/images/ai-resources/auto_simulation.png",
      "offline":
          "assets/html/ai/auto_paper_generator/auto_paper_Simulation/index.html",
      "folder": "assets/html/ai/auto_paper_generator/auto_paper_Simulation/",
    },
    {
      "title": "Auto Paper App",
      "image": "assets/images/ai-resources/auto_app.png",
      "offline":
          "assets/html/ai/auto_paper_generator/auto_paper_app/index.html",
      "folder": "assets/html/ai/auto_paper_generator/auto_paper_app/",
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("AI Auto Paper Generator")),
